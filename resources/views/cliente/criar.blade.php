                    ...
                    <div class="form-section">
                        ...
                        <div class="section-grid">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-input" name="cpf" id="cpf" placeholder="000.000.000-00"
                                    maxlength="14">
                            </div>
                            <div>
                        ...
                        <div class="address-grid">
                            ...
                            <div class="col-span-full">
                                <label for="complemento" class="form-label">Complemento: <span
                                        class="label-optional">(Opcional)</span></label>
                            ...
                            <div>
                                ...
                                <input type="text" class="form-input" name="estado" id="estado" placeholder="UF"
                                    maxlength="2">
                            </div>
                            <div class="col-span-full">
                                <label for="cep" class="form-label">CEP:</label>
                                <input type="text" class="form-input" name="cep" id="cep" maxlength="9" placeholder="00000-000"
                                    maxlength="14">
                            </div>
                        </div>
                    </div>
