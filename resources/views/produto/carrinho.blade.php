                ...
                <div class="cart-items-list">
                    ...
                    <div class="cart-item">
                        ...
                        <div class="cart-item-details">
                            ...
                            <form action="{{ route('atualizar.carrinho', ['produto' => $id]) }}" method="POST" class="cart-quantity-form">
                                @csrf
                                @method('PATCH')
                                <input type="number" name="quantidade" value="{{ $details['quantidade'] }}" min="1" class="cart-quantity-input">
                                <button type="submit" class="cart-update-button">Atualizar</button>
                            </form>
                        </div>

                        <div class="cart-item-actions">
                            <p class="cart-item-subtotal">R$ {{ number_format($details['preco'] * $details['quantidade'], 2, ',', '.') }}</p>
