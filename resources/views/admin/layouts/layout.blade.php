...
<body class="admin-body">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-content">
                <nav class="sidebar-nav">
                    <a href="{{ route('index.admin.produto') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="nav-link-icon" fill="none" viewBox="0 0 24 24"
                    ...
                    <a href="{{ route('clientes.admin') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="nav-link-icon" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="sidebar-footer">
                <a href="{{ route('layout') }}" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="footer-link-icon" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="header-right">
                    ...
                    <div class="user-profile-container">
                        <button class="user-profile-button">
                            <img src="https://placehold.co/40x40/E2E8F0/4A5568?text=A" alt="Avatar do usuário"
                                class="user-avatar">
    ...
    switches.forEach(function(el) {
        el.addEventListener('change', function() {
            ...
            fetch(`/produtos/${produtoId}/toggle-status`, { // Verifique se esta rota existe em seu web.php
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Opcional: Reverter o clique se der erro no servidor
